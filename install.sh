...
echo ""
echo "Client needs to use the files/kafka-truststore and password
present in files/truststore-password, and the user 'testkafka' 
to connect with kafka, the password for the user can be found
inside files/kafka-jaas.conf. A sample client properties file 
