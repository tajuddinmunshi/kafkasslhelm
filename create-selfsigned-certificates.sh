...
chmod 644 files/key-password files/keystore-password files/truststore-password
echo "###############################################################################################"
echo "NOTES:"
...
echo "You need to provide the dummy kafka-truststore and the 
corresponding truststore password(cat files/truststore-password) to client who connects to this kafka"
echo "###############################################################################################"
