...
#deleting kafka-truststore, kafka-keystore and password files
rm -rf files/kafka-truststore files/kafka-keystore files/key-password files/keystore-password files/truststore-password
